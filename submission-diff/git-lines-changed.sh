...
# `./git-diff-changed-lines branch1 branch2` etc.

# Outputs the lines numbers of the new file that are not
# present in the old file.
# That is, outputs line numbers for new lines and changed lines and does not output
# line numbers deleted or unchanged lines.

# FORMAT: One file per line
# FILE:LINE_NUMBERS
# Where LINE_NUMBERS is a
